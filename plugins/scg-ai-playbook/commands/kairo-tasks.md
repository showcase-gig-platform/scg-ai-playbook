...
# Description: 設計文書に基づいて実装タスクを分割し、依存関係を考慮した適切な順序で整理します。各タスクには実装詳細、テスト要件、UI/UX要件を含めます。
...
1. **設計文書の分析**
   ...
   - `docs/design/{要件名}/interfaces.*` を確認
...
タスク分割が完了したら、`/kairo-implement` で実装を開始してください。
